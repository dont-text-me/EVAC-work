...
to setup
  ...
  set total-eaten-plants 0
  set moves-harvesting-food 0
  set eaten-in-this-tick 0
  set moves-blank 0
...
to tick-animals
  ...
  set eaten-in-all-ticks (lput eaten-in-this-tick eaten-in-all-ticks)
  set eaten-in-this-tick 0
end
...
to checkForFood
  ...
  [
    set points (points + 1)
    set eaten-in-this-tick (eaten-in-this-tick + 1)
    set moves-harvesting-food (moves-harvesting-food + 1)
    ask foods-here [die]
    hatch-foods 1 [setup-foods foodSpawnPattern]
  ]
  [
    set moves-blank (moves-blank + 1)
  ]
end
@#$#@#$#@
GRAPHICS-WINDOW
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plot total-eaten-plants"
...
1034
483
Number of moves resulting in food eaten
moves-harvesting-food
1
1
11
...
1019
543
Number of moves not resulting in food
moves-blank
1
1
11
